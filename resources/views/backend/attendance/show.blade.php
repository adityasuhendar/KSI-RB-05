        ...
        <div class="w-full mt-8 bg-white rounded">
            ...
            <div class="w-full px-6 py-6">
                <div class="flex items-center justify-between bg-gray-600 rounded-tl rounded-tr">
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">Tanggal</div>
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">Guru</div>
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">Mata Pelajaran</div>
                    <div class="w-3/12 text-right text-white py-2 px-4 font-semibold">Kehadiran</div>
                </div>
                    ...
                    <div class="flex items-center justify-between border border-gray-200">
                        ...
                        <div class="w-3/12 text-xs text-right text-gray-600 py-2 px-4 font-semibold">
                            @if ($attendance->attendence_status)
                                <span class="bg-green-600 text-white px-2 py-1 rounded-custom">Hadir</span>
                            @else
                                <span class="bg-red-600 text-white px-2 py-1 rounded-custom">Absen</span>
                            @endif
                        </div>
                    </div>
                @endforeach
